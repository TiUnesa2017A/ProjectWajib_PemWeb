...
<body  style="background-image: url(unesa.jpg);background-repeat:no-repeat;background-size:cover;">
	...
	?>
   	<div class="container">
		...
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-globe"></i> <strong>Browse User</strong> <a href="add-users.php" class="float-right btn btn-link btn-sm"><i class="fa fa-fw fa-plus-circle"></i> Add Users</a></div>
			<div class="card-body">
				<?php
		...
		<div>
			<table class="table table-striped table-bordered" style="background-color:white">
				<thead>
					<tr class=" text-white" style="background-color:#00ccff">
						<th>No</th>
