...
<body  style="background-image: url(unesa.jpg);background-repeat:no-repeat;background-size:cover;">
	<div class="jumbotron" style="background-color: darkblue">
   	...
   	<div class="container" style="margin-top:-70px";>
		...
		?>
		<div class="card">
			<div class="card-header" style="color: red"><i class="fa fa-fw fa-plus-circle"></i> <strong>Add User</strong> <a href="browse-users.php" class="float-right btn btn-link btn-sm"><i class="fa fa-fw fa-globe"></i> Browse Users</a></div>
			<div class="card-body" style="justify-content: center;">
				...
				<div class="col-sm-6" style="justify-content: center;">
					<form method="post" style="justify-content: center;" enctype="multipart/form-data">
						...
						<div class="form-group">
							<button type="submit" name="submit" value="submit" id="submit" class="btn" style="background-color:skyblue"><i class="fa fa-fw fa-plus-circle"></i> Add User</button>
						</div>
					</form>
				</div>
			</div>
