...
insert  into `users`(id,username,userimage,userJk,userprodi,fakultas,nim,tgl_lahir,alamat,kota,email,created_at) values (37,'Malik Dwi','new up.jpg','Laki-laki','S1 Teknik Informatika','Fakultas Teknik',2147483647,'1998-05-29','Ketintang','Surabaya','malik.17051204024@mh','2019-05-25 10:52:26');
