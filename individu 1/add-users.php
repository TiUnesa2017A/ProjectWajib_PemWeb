...
<body style="background-image: url(bg5.jpg);">
		...
		?>
		<div class="card" align="center" style=" background-color: #E0E0E0; margin-left: 180px;margin-right: 180px">
			...
			<div class="card-body" style="justify-content: center;">
				...
				<div class="col-sm-9" style="justify-content: center;">
					<form method="post" style="justify-content: center;" enctype="multipart/form-data">
						...
						<div class="form-group">
							<button type="submit" name="submit" value="submit" id="submit" class="btn" style="background-color: #3366ff"><i class="fa fa-fw fa-plus-circle"></i> Add User</button>
						</div>
					</form>
				</div>
			</div>
