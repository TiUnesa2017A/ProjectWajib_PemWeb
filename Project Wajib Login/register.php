...
<div class="panel panel-default" style="margin-top:10px; background-color: #595959; color:white; border:0px">
    <div class="panel-body">
        <h3 class="text-center" style="font-weight:bolder;margin:10px 0; color:white">User Register</h3>
        <form method="post">
            ...
            <button type="submit" name="reg" class="btn btn-block" style="background-color: #4CAF50">Register</button>
            <p style="clear:both;">
                <div style="float:left;"></div>
                <div style="float:right; "><a href="index.php">Login, dengan akun yang sudah ada</a></div>
            </p>
        </form>
    </div>
</div>
