...
?>
<div class="panel panel-default" style="margin-top:10px; background-color:#595959; color:white; border:0px">
    <div class="panel-body">
                  <h3  style="font-weight:bolder;margin:10px 0; color:white; ">User Login</h3>
        <form method="post">
            ...
            <button type="submit" name="login" class="btn btn-block" style="background-color: #4CAF50" >Login</button>
            <p style="clear:both;">
                <div style="float:left;"><a href="forgot.php">Lupa Password</a></div>
