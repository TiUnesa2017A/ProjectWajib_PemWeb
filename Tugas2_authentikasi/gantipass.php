...
<nav class="navbar navbar-expand-sm navbar-dark" style="background-color: #1a63d8">
  <a class="navbar-brand" href="daftarmahasiswa.php"><b>Reset Password</b></a>
</nav>
<div class="container mt-5 p-5" style="background-color: #ededed; border-radius: 8px;">
	...
	<div class="row">
		...
		<div class="col-sm-6">
			...
			<button type="submit" name="submit" class="btn btn-primary mt-3 ml-3 float-right">Ganti Password</button><br>
			<a href="login.php" class="float-right">Halaman Login</a>
		</div>
