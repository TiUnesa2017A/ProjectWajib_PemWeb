...
<nav class="navbar navbar-expand-sm navbar-dark" style="background-color: #1a63d8">
  <a class="navbar-brand" href="daftar.php"><b>Regristation</b></a>
</nav>
<div class="container mt-5 p-5" style="background-color: #ededed; border-radius: 8px;">
	<h1><center>Registration Account</center></h1>
	<form method="post">
	<div class="row">
		<div class="col-sm-6">
		...
		<div class="col-sm-6">
			...
			<button type="submit" name="submit" class="btn btn-primary mt-3 float-right">Registration</button>
			</form>
			<a href="login.php" class="mt-4 mr-3 float-right">Log In</a>
		</div>
	</div>
