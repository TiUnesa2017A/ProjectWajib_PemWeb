...
<nav class="navbar navbar-expand-sm navbar-dark" style="background-color: #1a63d8">
  <a class="navbar-brand" href="daftarmahasiswa.php"><b>Halaman Login</b></a>
</nav>
...
<div class="row">
	...
	<div class="col-sm-6 p-4" style="background-color: #ededed; border-radius: 8px;">
		...
		<form method="post">
			...
			<button type="submit" name="submit" class="btn btn-primary mt-3 float-right">Login</button>
		</form>
		<a href="lupapass.php">Lupa Password</a>
		<a class="ml-3" href="daftar.php">Daftar</a>
	</div>
</div>
</div>
