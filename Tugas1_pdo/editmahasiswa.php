...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	header('location:daftarmahasiswa.php?msg=edit');
	exit;
	}
 ?>
<!DOCTYPE html>
...
<body>
<nav class="navbar navbar-expand-sm navbar-dark" style=" background-color: #2d7eff; ">
  <a class="navbar-brand" href="daftarmahasiswa.php"><b>PHP dengan PDO</b></a>
</nav>
<div class="container mt-5 mb-5" style="background-color: #e8e8e8; border-radius: 5px;">
	<a href="daftarmahasiswa.php"><button class="btn btn-primary float-right mt-3" >Daftar Mahasiswa</button></a>
	...
	<div class="row">
		...
		<div class="col-sm-6">
			...
			<select name="kota" class="form-control" required>
				...
				<option <?php if($row[0]['kota']=="Surabaya")echo 'selected' ?>value="Surabaya">Surabaya</option>
				<option <?php if($row[0]['kota']=="Sidoarjo")echo 'selected' ?>value="Sidoarjo">Sidoarjo</option>
				<option <?php if($row[0]['kota']=="Malang")echo 'selected' ?>value="Malang">Malang</option>
			</select>
