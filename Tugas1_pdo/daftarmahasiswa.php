...
<div class="container mt-5">
	...
	<a href="tambahmahasiswa.php"><button class="btn btn-primary float-left">Tambah Mahasiswa</button></a>
	<form method="get">
		<div class="row">
			<div class="col-sm-8">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center">
							<a href="infomahasiswa.php?id=<?php echo $val['id']; ?>"><button class="btn btn-info">Detail</button></a>
							<a href="editmahasiswa.php?id=<?php echo $val['id'];?>"><button class="btn btn-primary">Edit</button></a>
