...
<div class="panel panel-default" style="margin-top:80px;background-color:black; border-radius: 30px">
    <div class="panel-body">
        <h3 class="text-center" style="font-weight:bolder;margin:10px 0; color:green;">User Register</h3>
        <form method="post" style="color:green">
            ...
            <button type="submit" name="reg" class="btn btn-block" style="color: white;background-color:blue">Register</button>
            <p style="clear:both;">
