...
<div class="panel panel-default" style="margin-top:80px; color:green; background-color: black; border-radius: 30px">
    <div class="panel-body">
        <h3 class="text-center" style="font-weight:bolder;margin:10px 0; color:green;">User Login</h3>
        <form method="post">
