	...
	<br>
   	<div class="container">
		...
		if(isset($_REQUEST['msg']) and $_REQUEST['msg']=="name"){
			echo	'<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> Nama Mahasiswa is mandatory field!</div>';
		}elseif(isset($_REQUEST['msg']) and $_REQUEST['msg']=="jk"){
			echo	'<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> Jurusan is mandatory field!</div>';
		}elseif(isset($_REQUEST['msg']) and $_REQUEST['msg']=="image"){
			echo	'<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> Foto Mahasiswa is mandatory field!</div>';
		}elseif(isset($_REQUEST['msg']) and $_REQUEST['msg']=="prodi"){
			echo	'<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> Prodi is mandatory field!</div>';
