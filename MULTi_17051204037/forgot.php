...
?>
<div class="panel panel-default" style="margin-top:80px; background-color:rgba(255,128,0,0.7);">
    <div class="panel-body">
        <h3 class="text-center" style="font-weight:bolder;margin:10px 0;">Lupa Password</h3>
        <form method="post">
            ...
            <p style="clear:both;">
                <div style="float:left;"><a href="index.php">Login </a></div>
                <div style="float:right;"><a href="register.php">Register Pengguna Baru</a></div>
            </p>
        </form>
    </div>
</div>
