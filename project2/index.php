...
?>
<div class="panel panel-default" style="margin-top:80px; color:darkblue;">
    <div class="panel-body">
        <h3 class="text-center" style="font-weight:bolder;margin:10px 0; color:darkblue;">User Login</h3>
        <form method="post">
