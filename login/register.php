    ...
    <div class="panel-body">
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" class="form-control" placeholder="E-mail Anda" required/>
            </div>
            <div class="form-group">
            ...
            <button type="submit" name="reg" class="btn btn-danger btn-block">Register</button>
            <p style="clear:both;">
