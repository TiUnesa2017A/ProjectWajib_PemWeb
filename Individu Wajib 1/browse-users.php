						...
						<div class="row">
							<div class="col-sm-2">
								<div class="form-group">
									...
									<input type="text" name="username" id="username" class="form-control" value="<?php echo isset($_REQUEST['username'])?$_REQUEST['username']:''?>" placeholder="Masukkan Nama Mahasiswa">
								</div>
							</div>
							<div class="col-sm-2">
								<div class="form-group">
									<label>Jenis Kelamin</label>
									<input type="text" name="userJk" id="userJk" class="form-control" value="<?php echo isset($_REQUEST['userJk'])?$_REQUEST['userJk']:''?>" placeholder="Masukkan Jenis Kelamin">
								</div>
							</div>
							<div class="col-sm-2">
								<div class="form-group">
									<label>Prodi</label>
									<input type="tel" name="userprodi" id="userprodi" class="form-control" value="<?php echo isset($_REQUEST['userprodi'])?$_REQUEST['userprodi']:''?>" placeholder="Masukkan Prodi">
								</div>
							</div>
							<div class="col-sm-2">
								<div class="form-group">
