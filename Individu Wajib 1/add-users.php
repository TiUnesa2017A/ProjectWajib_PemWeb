...
<body>
	...
	<br>
   	<div class="container">
		<a href="browse-users.php"><h1 style="text-align: center;">PHP Data Object</h1></a>
		<?php
		if(isset($_REQUEST['msg']) and $_REQUEST['msg']=="name"){
			echo	'<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> Nama Mahasiswa tidak boleh kosong</div>';
			...
			echo	'<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> Foto Mahasiswa tidak boleh kosong</div>';
		...
		elseif(isset($_REQUEST['msg']) and $_REQUEST['msg']=="alamat"){
			echo	'<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> Alamat Tinggal tidak boleh kosong</div>';
		}
		...
		elseif(isset($_REQUEST['msg']) and $_REQUEST['msg']=="email"){
			echo	'<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> Email tidak boleh kosong</div>';
		}
				...
				<div class="col-sm-6" style="justify-content: center;">
					<form method="post" style="justify-content: center;" enctype="multipart/form-data">
						<div class="form-group">
							...
							<input type="text" name="username" id="username" class="form-control" placeholder="Masukkan Nama Mahasiswa" required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<select name="kota" id="kota" class="form-control" required>
								<option class="disable selected">-Pilih Kota Asal-</option>
