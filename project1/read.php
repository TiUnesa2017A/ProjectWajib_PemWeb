...
<body>
    ...
    <div class="container">
        ...
        ?>
        <div class="card">
            <div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Show User</strong> <a href="browse-users.php" class="float-right btn btn-success btn-sm"><i class="fa fa-fw fa-globe"></i> Browse Users</a></div>
            <div class="card-body">
                ...
                <a href="browse-users.php"><button type="button" class="btn btn-block btn-success">Back</button></a>
            </div>
        </div>
    </div>
