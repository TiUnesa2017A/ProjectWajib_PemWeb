...
<body>
	...
	?>
   	<div class="container">
		<a href="browse-users.php"><h1 style="text-align: center; color:green;">Aplikasi CRUD</h1></a>
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-globe" ></i> <strong>Browse User</strong> <a href="add-users.php" class="float-right btn btn-success btn-sm"><i class="fa fa-fw fa-plus-circle"></i> Add Users</a></div>
			<div class="card-body">
				<?php
						...
						<div class="row">
							<div class="col-sm-2">
								<div class="form-group">
									...
									<input type="text" name="username" id="username" class="form-control" value="<?php echo isset($_REQUEST['username'])?$_REQUEST['username']:''?>" placeholder="Username">
								</div>
							</div>
							<div class="col-sm-2">
								<div class="form-group">
			...
			<table class="table table-striped table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td align="center">
							<a href="edit-users.php?editId=<?php echo $val['id'];?>" class="text-warning"><i class="fa fa-fw fa-edit"></i> Edit</a> | 
