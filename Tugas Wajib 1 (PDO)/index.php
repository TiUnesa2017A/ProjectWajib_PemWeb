...
<html lang="en-US" xmlns:fb="https://www.facebook.com/2008/fbml" xmlns:addthis="https://www.addthis.com/help/api-spec"
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header"><strong>Browse User</strong> <a href="add-users.php"
                        ...
                        <form method="get">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <label>Gender</label>
                                        <input type="text" name="userJk" id="userJk" class="form-control"
                                            value="<?php echo isset($_REQUEST['userJk'])?$_REQUEST['userJk']:''?>"
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <label>Prodi</label>
                                        <input type="tel" name="userprodi" id="userprodi" class="form-control"
                                            value="<?php echo isset($_REQUEST['userprodi'])?$_REQUEST['userprodi']:''?>"
                                            placeholder="Enter user Prodi">
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                <a href="read.php?readId=<?php echo $val['id'];?>" class="text-info"> Details</a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
