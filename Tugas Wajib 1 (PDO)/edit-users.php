                    ...
                    <div class="col-sm-6">
                        <form method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="userJk" id="userJk" class="form-control"
                                    value="<?php echo $row[0]['userJk']; ?>" placeholder="Enter user email" required>
                            </div>
                            <div class="form-group">
                                <label>User image <span class="text-danger">*</span></label>
                                <input type="file" name="userimage" id="userimage" maxlength="12" class="form-control"
                                    value="<?php echo $row[0]['userimage']; ?>" placeholder="Enter user phone" required>
                            </div>
                            <div class="form-group">
