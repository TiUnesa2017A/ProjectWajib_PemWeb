...
<div class="panel panel-default" style="margin-top:80px; color:black;border-radius: 20px; background-color:#C8C8C8;opacity: 0.8">
    <div class="panel-body" >
        <h3 class="text-center" style="font-weight:bolder;margin:10px 0; color:black;">User Login</h3>
        <form method="post">
            ...
            <button type="submit" name="login" class="btn btn-block" style="background-color:#3385ff" >Login</button>
            <p style="clear:both;">
                <div style="float:left;"><a href="forgot.php" style="color: black">Forgot Password</a></div>
