...
<body>
    ...
    <div class="container" style="background-color:green;">
        ...
        ?>
        <div class="card">
            <div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Tampilkan Pengguna</strong> <a href="telusuri.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Temukan Pengguna</a></div>
            <div class="card-body">
                <div class="form-group" style="text-align: center;">
                            <img src="image/<?php echo $row[0]['userimage']; ?>" width="320" height="240">
                        </div><br>
                <div class="col-sm-6">
                    <form method="post">
                        <div class="form-group">
                            <label>Nama Pengguna: <span class="text-danger"><?php echo $row[0]['username']; ?></span></label>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Jurusan: <span class="text-danger"><?php echo $row[0]['userJk']; ?></span></label>
                        </div>
                        <div class="form-group">
                            <label>Prodi: <span class="text-danger"><?php echo $row[0]['userprodi']; ?></span></label>
                        </div>
                        <div class="form-group">
                ...
                <a href="telusuri.php"><button type="button" class="btn btn-block btn-primary">Kembali
                </button></a>
            </div>
        </div>
    </div>
