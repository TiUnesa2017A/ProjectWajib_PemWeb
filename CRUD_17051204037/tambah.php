...
<body background="black" >
	...
	<br>
   	<div class="container" style="background-color: green;">
		...
		?>
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Tambah pengguna</strong> <a href="telusuri.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Temukan Pengguna</a></div>
