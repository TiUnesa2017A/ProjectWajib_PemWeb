...
<body>
    ...
    <br>
    <div class="container">
        <a href="browse-users.php"><h1 style="text-align: center;background-color: yellow;">PHP CRUD</h1></a>
        <?php
        ...
        ?>
        <div class="card">
            <div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Tampilkan Pengguna</strong> <a href="browse-users.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Temukan Pengguna</a></div>
            <div class="card-body">
                ...
                <a href="browse-users.php"><button type="button" class="btn btn-block btn-primary">Kembali
                </button></a>
            </div>
        </div>
    </div>
