...
<body background="black" >
	...
	<main style="background-color: rgb(255,128,0);">
	<br>
   	<div class="container" ba>
		...
		?>
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Tambah pengguna</strong> <a href="browse-users.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Temukan Pengguna</a></div>
				...
				<div class="col-sm-6" style="justify-content: center;">
					<form method="post" style="justify-content: center;" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<option class="disable selected">pilih Gender</option>
						...
						<div class="form-group">
							...
							<select name="kota" id="kota" class="form-control" required>
								...
								<option value="Bandung">Jombang</option>
								<option value="Bandung">Sidoarjo</option>
								<option value="Bandung">Mojoketo</option>
						...
						<div class="form-group">
							<button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary"><i class="fa fa-fw fa-plus-circle"></i> Tambah Pengguna</button>
						</div>
					</form>
				</div>
			</div>
