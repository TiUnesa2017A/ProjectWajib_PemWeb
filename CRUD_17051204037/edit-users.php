...
<body>
	...
	<br>
   	<div class="container">
		...
		?>
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Edit Pengguna</strong> <a href="browse-users.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Temukan Pengguna</a></div>
			<div class="card-body">
