...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($update){
		header('location: telusuri.php?msg=rus');
		exit;
	}else{
		header('location: telusuri.php?msg=rnu');
		exit;
	}
}
?>
...
<body>
	...
	<br>
   	<div class="container" style="background-color: green;" >
		...
		?>
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Edit Pengguna</strong> <a href="telusuri.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Temukan Pengguna</a></div>
			<div class="card-body">
				...
				<div class="col-sm-6">
					<form method="post">
						...
						<div class="form-group">
							...
							<button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary"><i class="fa fa-fw fa-edit"></i>Perbarui pengguna</button>
						</div>
					</form>
				</div>
			</div>
