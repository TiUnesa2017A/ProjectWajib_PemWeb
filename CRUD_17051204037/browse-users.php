...
<body>
	...
	?>
   	<div class="container">
		...
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-globe"></i> <strong>Lihat pengguna</strong> <a href="add-users.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-plus-circle"></i> Tambah pengguna</a></div>
			<div class="card-body">
				<?php
