...
if(isset($_POST['login'])){
    ...
    try {
        $query="SELECT * FROM loginphp WHERE username=?";
...
?>
<div class="panel panel-default" style="margin-top:80px; color:orange;">
    <div class="panel-body">
        <h3 class="text-center" style="font-weight:bolder;margin:10px 0; color:orange;">User Login</h3>
        <form method="post">
